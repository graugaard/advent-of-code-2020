...
pub fn print_solution() {
		...
		println!("Day 03 Solution Part 1: {}",
						 map.count_trees_on_route(&Slope {
								 right: 3,
								 down: 1
						 }));

		println!("Day 03 Solution Part 2: {}",
						 day_03_part_2_solution(&map)
		);
}
...
mod tests {
		...
		pub fn convert_both_ground_and_tree() {
				assert_eq!(Map::convert_line("..#.##"), Ok(vec![Ground, Ground, Tree, Ground, Tree, Tree]));
		}
